...
- Built the interface with HTML, CSS, and JavaScript for a three-person course team.
- Used `fetch`, `async/await`, and the balldontlie REST API to retrieve player data.
...
- Designed Figma interfaces for inventory monitoring and automated restocking workflows.
